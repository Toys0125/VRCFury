Shader "Hidden/VRCFury/URP/SpsResolver" {
    Properties {
        [Header(Flags)]
    ...
    SubShader {
        ...
        Pass {
            Name "VRCFurySpsResolver"
            Tags { "LightMode" = "VRCFurySpsResolver" }
            Cull Off
            ZWrite Off
            ZTest Always
            Blend One Zero
            ...
            #include "../resolver/sps_resolver_types.cginc"
            #include "../resolver/sps_resolver_shader_types.cginc"
            #include "../resolver/sps_resolver_geom.cginc"
            #include "../resolver/sps_resolver_frag.cginc"
